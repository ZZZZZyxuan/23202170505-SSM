...
public final class AppConstants {
    ...
    // 用户相关常量
    public static final int USERNAME_MIN_LENGTH = 3; // 用户名最小长度
    ...
    public static final String SESSION_CURRENT_USER = "currentUser"; // Session用户key

    // 评论相关常量
    public static final int REVIEW_CONTENT_MAX_LENGTH = 500; // 评论内容最大长度
    public static final int RATING_MIN = 1; // 最低评分
    public static final int RATING_MAX = 5; // 最高评分

    // 响应状态码
    public static final int CODE_SUCCESS = 200; // 成功
    public static final int CODE_UNAUTHORIZED = 401; // 未授权
